...
# MAGIC <tr><td><pre>
# MAGIC Pair           |Cosine, Jaccard, Overlap, Dice 
# MAGIC cain - ceres             |   1.0,     1.0,     1.0,   1.0
# MAGIC gyration - oscillation   |   1.0,     1.0,     1.0,   1.0
# MAGIC prosecutor - reconstructed|   1.0,     1.0,     1.0,   1.0
# MAGIC condolence - zur         |   1.0,     1.0,     1.0,   1.0
# MAGIC sociedad - verde         |   1.0,     1.0,     1.0,   1.0
# MAGIC hong - kong              |0.8906,  0.7931,     1.0, 0.8846
# MAGIC cava - vena              |0.8819,  0.7778,     1.0, 0.875
# MAGIC first - time             |0.8715,  0.7703,  0.9199, 0.8703
# MAGIC time - well              |0.8639,  0.7599,    0.89, 0.8636
# MAGIC great - time             |0.8563,  0.7453,   0.921, 0.8541
# MAGIC time - way               |0.8525,  0.7396,  0.9169, 0.8503
# MAGIC part - time              | 0.846,  0.7308,  0.8989, 0.8445
# MAGIC nova - scotia            |0.8452,  0.7143,     1.0, 0.8333
# MAGIC great - upon             |0.8448,  0.7312,  0.8488, 0.8447
# MAGIC time - upon              |0.8447,  0.7283,  0.9042, 0.8428
# MAGIC new - time               |0.8428,  0.7239,  0.9164, 0.8398
# MAGIC part - well              |0.8406,  0.7244,   0.867, 0.8402
# MAGIC states - united          |0.8383,  0.7214,  0.8541, 0.8382
# MAGIC made - time              |0.8371,  0.7155,  0.9096, 0.8342
# MAGIC first - new              |0.8287,   0.707,  0.8538, 0.8284
# MAGIC </pre></td>
# MAGIC <td><pre>
# MAGIC Pair                  |Cosine, Jaccard, Overlap, Dice 
# MAGIC city - renal             |0.0075,  0.0025,    0.02, 0.005
# MAGIC differentiation - house  |0.0084,  0.0023,  0.0286, 0.0045
# MAGIC effectiveness - got      |0.0085,  0.0034,  0.0167, 0.0068
# MAGIC conditions - pulled      |0.0085,  0.0036,  0.0156, 0.0072
# MAGIC legislative - story      |0.0086,  0.0034,  0.0179, 0.0067
# MAGIC duty - located           |0.0086,   0.004,   0.013, 0.0079
# MAGIC group - listening        |0.0087,   0.003,  0.0217, 0.006
# MAGIC resulting - thou         |0.0087,  0.0041,  0.0122, 0.0082
# MAGIC completely - library     |0.0087,  0.0043,  0.0106, 0.0086
# MAGIC membrane - service       |0.0088,  0.0033,  0.0192, 0.0066
# MAGIC concentrations - never   |0.0088,   0.002,  0.0357, 0.004
# MAGIC highly - st              |0.0088,  0.0044,  0.0099, 0.0087
# MAGIC associated - kitchen     |0.0088,  0.0035,  0.0175, 0.007
# MAGIC calcium - government     |0.0088,  0.0024,  0.0294, 0.0049
# MAGIC complex - sat            |0.0088,  0.0044,  0.0095, 0.0088
# MAGIC agricultural - immediately|0.0089,  0.0039,  0.0152, 0.0077
# MAGIC st - tendency            |0.0089,  0.0044,  0.0099, 0.0088
# MAGIC bosom - theory           |0.0089,  0.0036,  0.0175, 0.0072
# MAGIC members - wet            |0.0089,  0.0032,  0.0213, 0.0063
# MAGIC values - window          |0.0089,  0.0045,  0.0099, 0.0089
# MAGIC </pre></td></tr>
# MAGIC </table>
